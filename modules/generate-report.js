...
async function generateReport (usedAddresses) {
  console.log("<br>ALL DONE! Generated report in: output directroy in root of this app.<br> \
   Click 'stop' to terminate this app and then go to output dir to inspect the results if any.");
